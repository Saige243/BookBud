...
function BookPageContainer({ props }) {
  ...
  const formattedPublishDate = moment(volumeInfo.publishedDate).format('MMMM D, YYYY')
  ...
  return (
    <div className='flex flex-row w-full m-2'>
      <div className='flex flex-col justify-center mr-2 text-center'>
        ...
        <div className='pt-2'>
          <p className='pb-2'>Pages:<br /> {volumeInfo.pageCount}</p>
          <p className='pb-2'>Published:<br /> {formattedPublishDate}</p>
